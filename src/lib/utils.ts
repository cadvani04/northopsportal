...
export const statusColors: Record<string, string> = {
  ...
  COLD_OUTREACH: "bg-violet-500/20 text-violet-300 border-violet-500/30",
  ...
  TEXT: "bg-teal-500/20 text-teal-300 border-teal-500/30",
  IN_PERSON: "bg-purple-500/20 text-purple-300 border-purple-500/30",
  ...
  NO_RESPONSE: "bg-amber-500/20 text-amber-300 border-amber-500/30",
  NOT_INTERESTED: "bg-red-500/20 text-red-300 border-red-500/30",
  OPENED: "bg-blue-500/20 text-blue-300 border-blue-500/30",
};
